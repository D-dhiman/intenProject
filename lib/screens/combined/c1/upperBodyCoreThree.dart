...
import 'Rest3.dart';
import 'upperBodyCoreFour.dart'; // Import the next screen file

class UpperBodyCoreThree extends StatefulWidget {
  const UpperBodyCoreThree({super.key});

  @override
  _UpperBodyCoreThreeState createState() => _UpperBodyCoreThreeState();
}

class _UpperBodyCoreThreeState extends State<UpperBodyCoreThree> with SingleTickerProviderStateMixin {
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => UpperBodyCoreFour()),
    );
  }
