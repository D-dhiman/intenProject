...
import 'Rest1.dart';
import 'upperBodyCoreFive.dart';

class UpperBodyCoreFour extends StatefulWidget {
  @override
  _UpperBodyCoreFourState createState() => _UpperBodyCoreFourState();
}

class _UpperBodyCoreFourState extends State<UpperBodyCoreFour> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/exercises/upperBodyCore/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => UpperBodyCoreFive()),
    );
  }
