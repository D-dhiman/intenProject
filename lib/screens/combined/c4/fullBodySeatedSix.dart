...
class FullBodySeatedSix extends StatefulWidget {
  @override
  _FullBodySeatedSixState createState() => _FullBodySeatedSixState();
}

class _FullBodySeatedSixState extends State<FullBodySeatedSix> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/exercises/fullBodySeated/six');
