...
import 'Rest1.dart';
import 'fullBodySeatedSix.dart';

class FullBodySeatedFive extends StatefulWidget {
  @override
  _FullBodySeatedFiveState createState() => _FullBodySeatedFiveState();
}

class _FullBodySeatedFiveState extends State<FullBodySeatedFive> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/exercises/fullBodySeated/five');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => FullBodySeatedSix()),
    );
  }
