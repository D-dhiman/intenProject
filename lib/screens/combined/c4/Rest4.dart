...
import 'FullBodySeatedFive.dart'; // Import the next screen for post-rest navigation
...
class _RestCardState extends State<Rest4> with SingleTickerProviderStateMixin {
  ...
  void navigateToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => FullBodySeatedFive()), // Next screen after rest
    );
  }
