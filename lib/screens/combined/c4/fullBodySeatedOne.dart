...
import 'Rest1.dart';
import 'fullBodySeatedTwo.dart'; // Import the next screen file

class FullBodySeatedOne extends StatefulWidget {
  @override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<FullBodySeatedOne>
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url =
          Uri.parse('http://localhost:3000/exercises/fullBodySeated/one');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => FullBodySeatedTwo()),
    );
  }
