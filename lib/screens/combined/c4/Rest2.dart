...
import 'fullBodySeatedThree.dart'; // Import the next screen for post-rest navigation
...
class _RestCardState extends State<Rest2> with SingleTickerProviderStateMixin {
  ...
  void navigateToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => FullBodySeatedThree()), // Next screen after rest
    );
  }
