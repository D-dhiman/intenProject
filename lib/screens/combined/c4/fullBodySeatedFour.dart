...
import 'Rest1.dart';
import 'fullBodySeatedFive.dart';

class FullBodySeatedFour extends StatefulWidget {
  @override
  _FullBodySeatedFourState createState() => _FullBodySeatedFourState();
}

class _FullBodySeatedFourState extends State<FullBodySeatedFour>
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url =
          Uri.parse('http://localhost:3000/exercises/fullBodySeated/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => FullBodySeatedFive()),
    );
  }
