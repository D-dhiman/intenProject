...
import 'Rest1.dart';
import 'upperBodyBackSix.dart';

class UpperBodyBackFive extends StatefulWidget {
  @override
  _UpperBodyBackFiveState createState() => _UpperBodyBackFiveState();
}

class _UpperBodyBackFiveState extends State<UpperBodyBackFive> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/exercises/upperBodyBack/five');
