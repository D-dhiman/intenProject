...
import 'Rest1.dart';
import 'upperBodyBackFive.dart';

class UpperBodyBackFour extends StatefulWidget {
  @override
  _UpperBodyBackFourState createState() => _UpperBodyBackFourState();
}

class _UpperBodyBackFourState extends State<UpperBodyBackFour> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/exercises/upperBodyBack/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => UpperBodyBackFive()),
    );
  }
