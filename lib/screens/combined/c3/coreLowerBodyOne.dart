...
import 'Rest1.dart';
import 'coreLowerBodyTwo.dart'; // Import the next screen file

class CoreLowerBodyOne extends StatefulWidget {
  @override
  _ExerciseScreenState createState() => _ExerciseScreenState();
}

class _ExerciseScreenState extends State<CoreLowerBodyOne>
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url =
          Uri.parse('http://localhost:3000/exercises/coreLowerBody/one');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => CoreLowerBodyTwo()),
    );
  }
