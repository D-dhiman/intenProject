...
import 'Rest1.dart';
import 'coreLowerBodyFive.dart';

class CoreLowerBodyFour extends StatefulWidget {
  @override
  _CoreLowerBodyFourState createState() => _CoreLowerBodyFourState();
}

class _CoreLowerBodyFourState extends State<CoreLowerBodyFour> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/exercises/coreLowerBody/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => CoreLowerBodyFive()),
    );
  }
