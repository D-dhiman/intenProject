...
import 'Rest1.dart';
import 'coreLowerBodySix.dart';

class CoreLowerBodyFive extends StatefulWidget {
  @override
  _CoreLowerBodyFiveState createState() => _CoreLowerBodyFiveState();
}

class _CoreLowerBodyFiveState extends State<CoreLowerBodyFive> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/exercises/coreLowerBody/five');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => CoreLowerBodySix()),
    );
  }
