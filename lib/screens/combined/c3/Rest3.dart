...
import 'coreLowerBodyFour.dart'; // Import the next screen for post-rest navigation
...
class _RestCardState extends State<Rest3> with SingleTickerProviderStateMixin {
  ...
  void navigateToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => CoreLowerBodyFour()), // Next screen after rest
    );
  }
