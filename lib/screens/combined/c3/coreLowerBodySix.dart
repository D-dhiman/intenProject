...
class CoreLowerBodySix extends StatefulWidget {
  @override
  _CoreLowerBodySixState createState() => _CoreLowerBodySixState();
}

class _CoreLowerBodySixState extends State<CoreLowerBodySix> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/exercises/coreLowerBody/six');
