...
class BackSix extends StatefulWidget {
  @override
  _BackSixState createState() => _BackSixState();
}

class _BackSixState extends State<BackSix> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/back/six');
