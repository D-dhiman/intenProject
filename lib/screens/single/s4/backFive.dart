...
class BackFive extends StatefulWidget {
  @override
  _BackFiveState createState() => _BackFiveState();
}

class _BackFiveState extends State<BackFive> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/back/five');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => BackSix()),
    );
  }
