...
import 'Rest1.dart';
import 'backFive.dart';

class BackFour extends StatefulWidget {
  @override
  _BackFourState createState() => _BackFourState();
}

class _BackFourState extends State<BackFour>
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url =
          Uri.parse('http://localhost:3000/single/back/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => BackFive()),
    );
  }
