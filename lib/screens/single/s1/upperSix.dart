...
class UpperSix extends StatefulWidget {
  @override
  _UpperSixState createState() => _UpperSixState();
}

class _UpperSixState extends State<UpperSix> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/upper/six');
