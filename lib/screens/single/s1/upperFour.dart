...
import 'Rest1.dart';
import 'upperFive.dart';

class UpperFour extends StatefulWidget {
  @override
  _UpperFourState createState() => _UpperFourState();
}

class _UpperFourState extends State<UpperFour> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/upper/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => UpperFive()),
    );
  }
