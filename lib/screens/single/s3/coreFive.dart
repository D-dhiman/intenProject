...
class CoreFive extends StatefulWidget {
  @override
  _CoreFiveState createState() => _CoreFiveState();
}

class _CoreFiveState extends State <CoreFive> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/core/five');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => CoreSix()),
    );
  }
