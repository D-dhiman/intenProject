...
class CoreSix extends StatefulWidget {
  @override
  _CoreSixState createState() => _CoreSixState();
}

class _CoreSixState extends State<CoreSix> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/core/six');
