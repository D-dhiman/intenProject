...
import 'Rest1.dart';
import 'coreFive.dart';

class CoreFour extends StatefulWidget {
  @override
  _CoreFourState createState() => _CoreFourState();
}

class _CoreFourState extends State<CoreFour> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/core/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => CoreFive()),
    );
  }
