...
class LowerSix extends StatefulWidget {
  @override
  _LowerSixState createState() => _LowerSixState();
}

class _LowerSixState extends State<LowerSix> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/lower/six');
