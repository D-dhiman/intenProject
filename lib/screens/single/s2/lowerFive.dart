...
import 'Rest1.dart';
import 'lowerSix.dart';

class LowerFive extends StatefulWidget {
  @override
  _LowerFiveState createState() => _LowerFiveState();
}

class _LowerFiveState extends State<LowerFive> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/lower/five');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => LowerSix()),
    );
  }
