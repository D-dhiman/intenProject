...
import 'Rest1.dart';
import 'lowerFive.dart';

class LowerFour extends StatefulWidget {
  @override
  _LowerFourState createState() => _LowerFourState();
}

class _LowerFourState extends State<LowerFour> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/lower/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => LowerFive()),
    );
  }
