...
import 'Rest1.dart';
import 'shoulderFive.dart';

class ShoulderFour extends StatefulWidget {
  @override
  _ShoulderFourState createState() => _ShoulderFourState();
}

class _ShoulderFourState extends State<ShoulderFour>
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url =
          Uri.parse('http://localhost:3000/single/shoulder/four');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ShoulderFive()),
    );
  }
