...
class ShoulderSix extends StatefulWidget {
  @override
  _ShoulderSixState createState() => _ShoulderSixState();
}

class _ShoulderSixState extends State<ShoulderSix> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/shoulder/six');
