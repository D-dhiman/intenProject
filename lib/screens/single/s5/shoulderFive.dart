...
import 'Rest1.dart';
import 'shoulderSix.dart';

class ShoulderFive extends StatefulWidget {
  @override
  _ShoulderFiveState createState() => _ShoulderFiveState();
}

class _ShoulderFiveState extends State<ShoulderFive> with SingleTickerProviderStateMixin {
  ...
  Future<void> fetchExerciseData() async {
    try {
      final url = Uri.parse('http://localhost:3000/single/shoulder/five');
  ...
  void skipToNextScreen() {
    Navigator.pushReplacement(
      context,
      MaterialPageRoute(builder: (context) => ShoulderSix()),
    );
  }
